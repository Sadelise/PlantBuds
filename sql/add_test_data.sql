...
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Kasvattajan_id), (SELECT * FROM Jukan_id), '2003-03-21', 'elossa', 'Pohjois-ikkuna', 0.5, 'kaupallinen', 'kekkilä', 'kerran viikossa', 'kerran kuukaudessa', 'Pistokkaasta kasvatettu. Tiinan kasvi.', NOW() );
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Pertin_id), (SELECT * FROM Jukan_id), '2003-03-21', 'elossa', 'Etelä-ikkuna', 1.0, 'kaupallinen', 'biolan', 'kerran kuukaudessa', 'ei koskaan', 'Plantagenista ostettu. Pertin kasvi.', NOW() );
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Pertin_id), 2, '2003-03-21', 'elossa', 'Etelä-ikkuna', 0.5, 'sekoitus', 'Kookoskuitu+perliitti', 'kerran viikossa', 'kerran kahdessa viikossa', 'Siemenestä kasvatettu. Pertin kasvi.', NOW() );
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Pertin_id), 3, '05.12.2007', 'elossa', 'Etelä-ikkuna', 1.0, 'kaupallinen', 'kekkilä', 'kerran kuukaudessa', 'kerran kahdessa viikossa', 'Raision kukkatalosta ostettu. Pertin kasvi.', NOW() );
