...
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Pertin_id), (SELECT * FROM Jukan_id), '2003-03-21', 'elossa', 'Eteläikkuna', 1.0, 'kaupallinen', 'biolan', 'kerran kuukaudessa', 'ei koskaan', 'Plantagenista ostettu. Pertin kasvi.', NOW() );
INSERT INTO Owned_Plant (grower_id, plant_id, acquisition, status, location, distance_window, soil, soil_description, watering, fertilizing, details, added) VALUES ((SELECT * FROM Pertin_id), 2, '2003-03-21', 'elossa', 'Eteläikkuna', 0.5, 'sekoitus', 'Kookoskuitu+perliitti', 'kerran viikossa', 'kerran kahdessa viikossa', 'Siemenestä kasvatettu. Pertin kasvi.', NOW() );
